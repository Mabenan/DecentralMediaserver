...
export class delete1567343240744 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("ALTER TABLE `file` ADD `deleted` tinyint NOT NULL DEFAULT 0");
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `file` DROP COLUMN `deleted`");
